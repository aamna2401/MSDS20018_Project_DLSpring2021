...
from configurations.test_config import test_cfg
from dataloader.datagen import CustomDataLoader
from utils.bboxes import draw_box
from utils.training import create_model
...
def test():
    ...
    test_data_set = CustomDataLoader(test_cfg.data_root_dir, 'val', data_transform)
